// Script to initialize database with bowl games and CFP games
...
const bowlGames = [
    ...
    { id: 24, name: "Snoop Dogg Arizona Bowl", team1: "Miami-OH (+3.5pts)", team2: "Fresno State", date: "2025-27" },
            ...
            db.serialize(() => {
                ...
                db.close((err) => {
                    if (err) reject(err);
                        ...
                        console.log('Database initialized with bowl games and CFP games');
                        resolve();
                    }
                });
            });
